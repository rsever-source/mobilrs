...
.vehicle-grid{display:grid;grid-template-columns:repeat(2,minmax(0,360px));justify-content:center;gap:8px}.vehicle-card{border:1px solid var(--line);border-radius:12px;background:#fff;padding:10px 12px;display:flex;align-items:center;justify-content:space-between;gap:10px;min-width:0}.vehicle-card .vehicle-info{min-width:0}.vehicle-card .brandline{font-size:10px;color:var(--muted);font-weight:750;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.vehicle-card h3{margin:2px 0 1px;font-size:13px;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.vehicle-card .trim{font-size:10px;color:var(--muted);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.vehicle-card .price-line{flex:0 0 auto;text-align:right}.vehicle-card .price-label{font-size:8px;color:var(--muted);white-space:nowrap}.vehicle-card .price{font-size:13px;font-weight:850;white-space:nowrap}.vehicle-card .arrow{display:none}
