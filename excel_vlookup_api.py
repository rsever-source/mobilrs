...
function otvRateFor(v){let p=Number(v.price||0),b=(v.brand||'').toUpperCase(),m=(v.model||'').toUpperCase();if(!p)return null;let solve=(rules)=>{for(let [r,min,max] of rules){let base=p/1.20/(1+r);if(base>min&&(max==null||base<=max))return r}return null};if(b==='TOGG')return solve([[.25,0,1650000],[.55,1650000,null]]);if(b==='TOYOTA'&&m.includes('C-HR'))return solve([[.70,0,1250000],[.80,1250000,null]]);if(b==='TOYOTA'&&m.includes('COROLLA'))return solve([[.75,0,850000],[.80,850000,1100000],[.90,1100000,1650000],[1.00,1650000,null]]);if(b==='FIAT'&&m.includes('ULYSSE'))return solve([[1.50,0,1650000],[1.70,1650000,null]]);if(b==='FIAT'&&m.includes('EGEA'))return solve([[.75,0,850000],[.80,850000,1100000],[.90,1100000,1650000],[1.00,1650000,null]])||solve([[.70,0,650000],[.75,650000,900000],[.80,900000,1100000],[.90,1100000,null]]);return solve([[.70,0,650000],[.75,650000,900000],[.80,900000,1100000],[.90,1100000,null]])}function exemptPrice(v){let r=otvRateFor(v);return r==null?null:Math.round(Number(v.price)/(1+r))}function vehicleImage(v){let b=(v.brand||'').toUpperCase(),m=(v.model||'').toUpperCase();if(b==='RENAULT'&&m.includes('BOREAL'))return 'https://www.automovelnacional.com.br/admin/imagens/editor/2002102722.jpg';if(b==='RENAULT'&&m.includes('DUSTER'))return 'https://imgd.aeplcdn.com/1920x1080/n/cw/ec/163801/duster-exterior-right-front-three-quarter-5.jpeg?isig=0&q=90';if(b==='RENAULT'&&m.includes('CLIO'))return 'https://cms.bilhandel.dk/media/gihc2rsz/g0vc5o6wmaaitkp.jpeg';if(b==='RENAULT'&&m.includes('MEGANE'))return 'https://www.renault.com.tr/binek-araclar/megane-sedan.html';if(b==='TOYOTA'&&m.includes('C-HR'))return 'https://www.toyota.com.tr/araba-modelleri/c-hr';if(b==='TOYOTA'&&m.includes('COROLLA'))return 'https://www.toyota.com.tr/araba-modelleri/corolla-sedan';if(b==='HYUNDAI'&&m.includes('I20'))return 'https://www.hyundai.com/tr/tr/modeller/i20.html';if(b==='HYUNDAI'&&m.includes('BAYON'))return 'https://www.hyundai.com/tr/tr/modeller/bayon.html';if(b==='TOGG')return 'https://www.togg.eu/assets/img/68a4514343d1be59b0dab71b_T10X-Range.webp';if(b==='FIAT'&&m.includes('EGEA CROSS'))return 'https://www.fiat.com.tr/modeller/egea-cross';if(b==='FIAT'&&m.includes('EGEA'))return 'https://www.fiat.com.tr/modeller/egea';if(b==='FIAT'&&m.includes('ULYSSE'))return 'https://manage.sifiraracal.com/public/resim/galeri/1002/43084/fiat-ulysse.png';return ''}function verifiedRow(v){let ep=exemptPrice(v),img=vehicleImage(v);return `<div class="row"><div class="rowtop"><div class="vehicle-main"><div class="vehicle-mini">${img?`<img src="${img}" loading="lazy" alt="${v.brand} ${v.model}" onerror="this.parentElement.textContent='🚗';">`:'🚗'}</div><div><div class="name">${v.brand} ${v.model}</div><div class="meta">${v.trim||''}</div></div></div><span class="tag">Uygun</span></div><div class="price">Liste Fiyatı<b>${tl(v.price)}</b></div>${ep?`<div class="price">Tahmini ÖTV Muaf Fiyat<b>${tl(ep)}</b></div>`:''}<div class="note">Yerlilik: %${v.locality||'—'} · Kaynak: ${v.source_name||v.brand} · Son kontrol: ${v.checked_at||'—'}</div></div>`}
