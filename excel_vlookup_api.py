...
<div class="section"><div class="section-head"><div><h2>Güncel ÖTV muaf araçlar</h2></div><div id="heroTime" style="font-size:10px;color:var(--muted);text-align:right;white-space:nowrap">Son kontrol: —</div></div><div id="homeVehicles" class="vehicle-grid"></div><div class="more"><button class="primary" onclick="openPage(&quot;otv&quot;)">Tüm araçları gör →</button></div></div>
