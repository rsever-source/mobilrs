...
<style>
:root{--blue:#0b57e3;--blue2:#1d6cff;--green:#18a957;--ink:#111827;--muted:#6b7280;--line:#e6e9ef;--bg:#f5f7fb}*{box-sizing:border-box}body{margin:0;background:var(--bg);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--ink)}.app{max-width:520px;margin:auto;min-height:100vh;background:#fff;padding:18px 16px 88px}.top{font-size:28px;font-weight:850;margin:10px 2px 18px}.hero{background:linear-gradient(145deg,var(--blue2),#0745cb);color:#fff;border-radius:22px;padding:18px;box-shadow:0 14px 35px #0b57e32b}.hero h2{margin:0 0 5px;font-size:21px}.sub{font-size:13px;opacity:.9}.herogrid{display:grid;grid-template-columns:1fr 1fr;margin:18px 0 14px}.metric+.metric{border-left:1px solid #ffffff55;padding-left:18px}.metric small{display:block;opacity:.82}.metric b{display:block;font-size:24px;margin-top:3px}.hero button{width:100%;border:0;border-radius:12px;padding:12px;background:#fff;color:var(--blue);font-weight:800}.chips{display:flex;gap:8px;overflow:auto;padding:14px 0 4px;scrollbar-width:none}.chip{border:1px solid var(--line);background:#fff;border-radius:999px;padding:8px 13px;white-space:nowrap;font-weight:700;font-size:12px}.chip.on{background:var(--blue);color:#fff;border-color:var(--blue)}.sec{display:flex;justify-content:space-between;align-items:center;margin:18px 2px 10px}.sec h3{margin:0;font-size:17px}.link{color:var(--blue);font-size:12px;font-weight:750}.cars{display:grid;grid-template-columns:1fr 1fr;gap:10px}.car{border:1px solid var(--line);border-radius:17px;padding:12px;background:#fff}.car .badge{float:right;background:#e8f8ee;color:#168143;font-size:10px;padding:5px 8px;border-radius:999px}.car .emoji{font-size:32px;margin:7px 0}.car b{display:block;font-size:14px}.car small{display:block;color:var(--muted);font-size:11px;margin:3px 0 8px}.prices{display:grid;grid-template-columns:1fr 1fr;gap:5px;font-size:9px;color:var(--muted)}.prices strong{display:block;color:var(--ink);font-size:11px;margin-top:2px}.prices .muaf strong{color:var(--green)}.projects{display:grid;grid-template-columns:1fr 1fr;gap:10px}.p{border:1px solid var(--line);border-radius:17px;padding:14px;display:flex;gap:10px;align-items:center;background:#fff}.ico{width:38px;height:38px;border-radius:11px;background:#eef4ff;display:grid;place-items:center;font-size:20px}.p b{font-size:13px}.p small{display:block;color:var(--muted);font-size:10px;margin-top:3px}.homebtn{position:fixed;left:50%;bottom:18px;transform:translateX(-50%);border:1px solid var(--line);background:#fff;color:var(--blue);border-radius:999px;padding:10px 18px;font-weight:800;box-shadow:0 7px 25px #0001;z-index:9}.page{display:none}.page.on{display:block}.back{border:0;background:none;font-size:25px;padding:4px 8px 4px 0}.pagehead{display:flex;align-items:center;gap:8px;margin-bottom:16px}.pagehead h2{margin:0;font-size:21px}.panel{border:1px solid var(--line);border-radius:18px;padding:15px;margin-bottom:12px}.field{display:block;margin:12px 0 6px;font-size:12px;font-weight:800}.input,select,textarea{width:100%;border:1px solid #d9dee8;border-radius:13px;padding:13px;font-size:16px;background:#fff}textarea{height:88px}.btn{width:100%;border:0;border-radius:13px;padding:14px;background:var(--blue);color:#fff;font-size:15px;font-weight:800;margin-top:12px}.green{background:#168f50}.purple{background:#6857df}.result{display:none;margin-top:12px;border-radius:16px;background:#f3f7ff;padding:16px}.result .big{font-size:28px;font-weight:900;color:var(--blue);text-align:center;margin:8px 0}.list{display:grid;gap:10px}.row{border:1px solid var(--line);border-radius:16px;padding:13px}.rowtop{display:flex;justify-content:space-between}.row .tag{background:#e8f8ee;color:#168143;padding:4px 8px;border-radius:999px;font-size:10px}.row .name{font-weight:850}.row .meta{font-size:11px;color:var(--muted);margin-top:3px}.rowprices{display:grid;grid-template-columns:1fr 1fr;margin-top:10px;font-size:10px;color:var(--muted)}.rowprices b{display:block;color:#111;font-size:14px;margin-top:2px}.rowprices .m b{color:var(--green)}.filebox{position:relative;border:2px dashed #d6dbe5;border-radius:14px;padding:18px;text-align:center;margin:10px 0;color:var(--muted);font-size:12px}.filebox input{position:absolute;inset:0;opacity:0;width:100%;height:100%}.note{font-size:11px;color:var(--muted);line-height:1.5;margin-top:8px}
</style></head><body><main class="app"><section id="home" class="page on"><div class="top">RDV Asistan</div><div class="hero"><h2>🚗 ÖTV Muaf Araçlar</h2><div class="sub">Resmî sitelerden anlık güncel uygun araç listesi</div><div class="herogrid"><div class="metric"><small>Bugün uygun</small><b id="heroCount">—</b></div><div class="metric"><small>Son güncelleme</small><b id="heroTime">—</b></div></div><button onclick="openPage('otv')">Tümünü Gör ›</button></div><div id="brandChips" class="chips"></div><div class="sec"><h3>Bugün Uygun</h3><span class="link" onclick="openPage('otv')">Tümünü Gör</span></div><div id="previewCars" class="cars"></div><div class="sec"><h3>Projeler</h3></div><div class="projects"><div class="p" onclick="openPage('kira')"><div class="ico">🏠</div><div><b>Kira Hesaplama</b><small>TÜFE ile kira artışı</small></div></div><div class="p" onclick="openPage('excel')"><div class="ico">📊</div><div><b>Excel</b><small>Düşeyara, birleştirme, pivot</small></div></div><div class="p" onclick="openPage('imgpdf')"><div class="ico">📄</div><div><b>Resim → PDF</b><small>Fotoğrafları tek PDF yap</small></div></div><div class="p" onclick="openPage('pdfexcel')"><div class="ico">🟢</div><div><b>PDF → Excel</b><small>Tablo ve metni Excel'e aktar</small></div></div></div></section><section id="otv" class="page"><div class="pagehead"><button class="back" onclick="openPage('home')">‹</button><h2>ÖTV Muaf Araçlar</h2></div><div class="panel"><b id="otvSummary">Yükleniyor…</b><div class="note">2026 üst limit: <b id="otvLimit">—</b> · Yerli katkı oranı en az %40. Resmî marka kaynakları günlük kontrol edilir.</div></div><div id="otvChips" class="chips"></div><div id="otvList" class="list"></div></section><section id="kira" class="page"><div class="pagehead"><button class="back" onclick="openPage('home')">‹</button><h2>Kira Hesaplama</h2></div><div class="panel"><form onsubmit="kiraHesapla(event)"><label class="field">Mevcut kira</label><input id="mevcut-kira" class="input" type="number" min="1" step=".01" placeholder="Örn: 12000" required><label class="field">Kira yenileme ayı</label><select id="yenileme-ayi" required><option value="">Ay seç</option><option value="1">Ocak</option><option value="2">Şubat</option><option value="3">Mart</option><option value="4">Nisan</option><option value="5">Mayıs</option><option value="6">Haziran</option><option value="7">Temmuz</option><option value="8">Ağustos</option><option value="9">Eylül</option><option value="10">Ekim</option><option value="11">Kasım</option><option value="12">Aralık</option></select><button id="kira-btn" class="btn">Hesapla</button></form><div id="kira-result" class="result"></div></div></section><section id="excel" class="page"><div class="pagehead"><button class="back" onclick="openPage('home')">‹</button><h2>Excel</h2></div><div class="panel"><form action="/excel-islem" method="post" enctype="multipart/form-data"><div class="filebox">＋ 1. Excel (Ana Dosya)<input type="file" name="file1" accept=".xlsx,.xls" required></div><div class="filebox">＋ 2. Excel (Referans Dosyası)<input type="file" name="file2" accept=".xlsx,.xls" required></div><label class="field">İşlem</label><textarea name="komut" placeholder="Örn: Dosyaları Musteri_ID sütunundan düşeyara yap." required></textarea><button class="btn">Excel İşlemini Başlat</button></form></div></section><section id="imgpdf" class="page"><div class="pagehead"><button class="back" onclick="openPage('home')">‹</button><h2>Resim → PDF</h2></div><div class="panel"><form action="/resim-pdf-islem" method="post" enctype="multipart/form-data"><div class="filebox">＋ Fotoğrafları Seç<input type="file" name="images" accept=".png,.jpg,.jpeg" multiple required></div><button class="btn purple">PDF Yap</button></form></div></section><section id="pdfexcel" class="page"><div class="pagehead"><button class="back" onclick="openPage('home')">‹</button><h2>PDF → Excel</h2></div><div class="panel"><form action="/pdf-excel-islem" method="post" enctype="multipart/form-data"><div class="filebox">＋ PDF Dosyasını Seç<input type="file" name="pdf_file" accept=".pdf" required></div><button class="btn green">PDF'i Excel'e Çevir</button></form></div></section><button class="homebtn" onclick="openPage('home')">⌂ &nbsp;Ana Sayfa</button></main><script>
let otvData={vehicles:[],limit:2873900},activeBrand='Tümü';function openPage(id){document.querySelectorAll('.page').forEach(x=>x.classList.remove('on'));document.getElementById(id).classList.add('on');scrollTo(0,0);if(id==='otv')renderOTV()}function tl(v){return Number(v||0).toLocaleString('tr-TR')+' ₺'}function card(v){return `<div class="car"><span class="badge">Uygun</span><div class="emoji">🚘</div><b>${v.brand} ${v.model}</b><small>${v.trim||v.fuel||''}</small><div class="prices"><div>Liste Fiyatı<strong>${tl(v.price)}</strong></div><div class="muaf">Muaf Fiyat<strong>${tl(v.exempt_price)}</strong></div></div></div>`}function row(v){return `<div class="row"><div class="rowtop"><div><div class="name">${v.brand} ${v.model}</div><div class="meta">${v.trim||''} · ${v.fuel||''}</div></div><span class="tag">Uygun</span></div><div class="rowprices"><div>Liste Fiyatı<b>${tl(v.price)}</b></div><div class="m">Muaf Fiyatı<b>${tl(v.exempt_price)}</b></div></div><div class="note">Kaynak: ${v.source_name||v.brand} · Son kontrol: ${v.checked_at||'—'}</div></div>`}function buttons(target){const bs=['Tümü',...new Set(otvData.vehicles.map(v=>v.brand))];document.getElementById(target).innerHTML=bs.map(b=>`<button class="chip ${b===activeBrand?'on':''}" onclick="setBrand('${b}')">${b}</button>`).join('')}function setBrand(b){activeBrand=b;renderHome();renderOTV()}function renderHome(){document.getElementById('heroCount').textContent=otvData.vehicles.length+' araç';document.getElementById('heroTime').textContent=otvData.updated_time||'—';buttons('brandChips');let a=otvData.vehicles.filter(v=>activeBrand==='Tümü'||v.brand===activeBrand).slice(0,2);document.getElementById('previewCars').innerHTML=a.map(card).join('')||'<div class="note">Bu markada uygun araç yok.</div>'}function renderOTV(){document.getElementById('otvLimit').textContent=tl(otvData.limit);document.getElementById('otvSummary').textContent=otvData.vehicles.length+' uygun araç · Son güncelleme '+(otvData.updated_at||'—');buttons('otvChips');let a=otvData.vehicles.filter(v=>activeBrand==='Tümü'||v.brand===activeBrand);document.getElementById('otvList').innerHTML=a.map(row).join('')||'<div class="panel">Uygun araç bulunamadı.</div>'}async function loadOTV(){try{let r=await fetch('/api/otv');otvData=await r.json();renderHome()}catch(e){document.getElementById('heroCount').textContent='—'}}async function kiraHesapla(e){e.preventDefault();let b=document.getElementById('kira-btn'),res=document.getElementById('kira-result');b.disabled=true;b.textContent='Hesaplanıyor...';res.style.display='block';res.innerHTML='Güncel TÜFE kontrol ediliyor...';try{let body=new URLSearchParams();body.append('mevcut_kira',document.getElementById('mevcut-kira').value);body.append('yenileme_ayi',document.getElementById('yenileme-ayi').value);let r=await fetch('/kira-hesapla',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded'},body});let d=await r.json();if(!r.ok)throw Error(d.detail||'Hesaplama yapılamadı.');res.innerHTML=`<div class="note" style="text-align:center">12 aylık ortalama TÜFE</div><div class="big">%${d.oran}</div><div class="note" style="text-align:center">Yeni kira</div><div class="big">${d.yeni_kira}</div><div class="note">${d.durum}</div>`}catch(x){res.innerHTML='<div class="note">'+x.message+'</div>'}finally{b.disabled=false;b.textContent='Hesapla'}}loadOTV();
</script></body></html>'''
