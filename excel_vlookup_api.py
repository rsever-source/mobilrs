...
async def robots_txt():
    return HTMLResponse("User-agent: *\nAllow: /\nSitemap: https://rdvsever.onrender.com/sitemap.xml\n", media_type="text/plain")


@app.get("/sitemap.xml", response_class=HTMLResponse)
async def sitemap_xml():
    return HTMLResponse("<?xml version=\"1.0\" encoding=\"UTF-8\"?><urlset xmlns=\"http://www.sitemaps.org/schemas/sitemap/0.9\"><url><loc>https://rdvsever.onrender.com/</loc></url></urlset>", media_type="application/xml")
