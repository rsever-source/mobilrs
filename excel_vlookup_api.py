...
.page{display:none}.page.on{display:block}.home{padding:30px}.hero{padding:30px;border:1px solid #dce6f6;border-radius:24px;background:linear-gradient(135deg,#f8fbff,#edf4ff)}.eyebrow{font-size:12px;font-weight:800;color:var(--blue);letter-spacing:.08em;text-transform:uppercase;margin-bottom:9px}.hero{position:relative}.hero h1{margin:0;font-size:36px;line-height:1.08;letter-spacing:-1.2px}.hero p{margin:10px 0 0;max-width:680px;color:var(--muted);font-size:15px;line-height:1.55}.hero-stats{display:grid;grid-template-columns:repeat(2,1fr);gap:12px;margin-top:24px}.hero-stats .stat:last-child{position:absolute;right:24px;top:22px;width:auto;min-width:145px;padding:8px 11px}.hero-stats .stat:last-child small{font-size:9px}.hero-stats .stat:last-child b{font-size:13px;margin-top:2px}.stat{background:#fff;border:1px solid #dfe7f3;border-radius:16px;padding:15px 17px}.stat small{display:block;color:var(--muted);font-size:11px}.stat b{display:block;margin-top:4px;font-size:22px;letter-spacing:-.3px}.section{margin-top:28px}.section-head{display:flex;align-items:end;justify-content:space-between;gap:15px;margin-bottom:12px}.section-head h2{margin:0;font-size:21px;letter-spacing:-.4px}.section-head p{margin:0;color:var(--muted);font-size:12px}
...
@media(max-width:900px){.vehicle-grid{grid-template-columns:repeat(2,minmax(0,360px))}.tool-grid{grid-template-columns:1fr 1fr}}
