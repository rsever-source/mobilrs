...
<style>
:root{--blue:#0b57e3;--blue2:#1d6cff;--green:#18a957;--ink:#111827;--muted:#6b7280;--line:#e6e9ef;--bg:#f5f7fb}*{box-sizing:border-box}body{margin:0;background:var(--bg);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--ink)}.app{max-width:520px;margin:auto;min-height:100vh;background:#fff;padding:18px 16px 88px}.top{display:flex;align-items:center;gap:11px;margin:10px 2px 18px}.brandmark{width:42px;height:42px;border-radius:12px;background:linear-gradient(145deg,#183a72,#0f2b58);color:#fff;display:grid;place-items:center;font-size:20px;font-weight:800;letter-spacing:-1px;box-shadow:0 6px 18px #0b57e31f}.brandname{font-size:25px;font-weight:850}.hero{background:linear-gradient(145deg,#fff,#f3f6fd);color:var(--ink);border:1px solid #e1e7f1;border-radius:22px;padding:16px;box-shadow:0 10px 28px #0b57e312}.herotop{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.hero h2{margin:7px 0 5px;font-size:21px}.carbadge{width:38px;height:38px;border-radius:11px;background:#eef4ff;display:grid;place-items:center;font-size:20px}.sub{font-size:12px;color:var(--muted);line-height:1.35}.check{text-align:right;min-width:112px;padding-top:3px}.loading{font-size:11px!important;line-height:1.2!important;white-space:nowrap}.check small{display:block;color:var(--muted);font-size:10px}.check b{display:block;color:var(--blue);font-size:16px;margin-top:4px}.herofoot{display:flex;gap:34px;align-items:end;margin:14px 0 12px}.herofoot small{display:block;color:var(--muted);font-size:10px}.herofoot b{display:block;font-size:22px;color:var(--blue);margin-top:3px}.hero button{width:100%;border:0;border-radius:12px;padding:12px;background:var(--blue);color:#fff;font-weight:800}.chips{display:flex;gap:8px;overflow:auto;padding:12px 0 8px;scrollbar-width:none}.chip{border:1px solid var(--line);background:#fff;border-radius:999px;padding:8px 13px;white-space:nowrap;font-weight:700;font-size:12px}.chip.on{background:var(--blue);color:#fff;border-color:var(--blue)}.sec{display:flex;justify-content:space-between;align-items:center;margin:18px 2px 10px}.sec h3{margin:0;font-size:17px}.projects{display:grid;grid-template-columns:1fr 1fr;gap:10px}.p{border:1px solid var(--line);border-radius:17px;padding:14px;display:flex;gap:10px;align-items:center;background:#fff};.sectionlink{border:0;background:transparent;color:var(--blue);font-weight:800;font-size:12px;padding:7px 2px;cursor:pointer}.homevehicles{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;overflow:visible}.homecar{border:1px solid var(--line);border-radius:18px;padding:14px;background:linear-gradient(145deg,#fff,#f6f8fc);cursor:pointer;min-width:0;transition:transform .15s ease,box-shadow .15s ease,border-color .15s ease}.homecar .carpic{height:104px;border-radius:13px;background:linear-gradient(135deg,#eaf1ff,#f7f9fc);display:grid;place-items:center;font-size:30px;margin-bottom:10px}.homecar .carbrand{font-size:10px;color:var(--muted);font-weight:800}.homecar .carmodel{font-size:13px;font-weight:900;line-height:1.2;margin-top:3px;overflow-wrap:anywhere}.homecar .carprice{font-size:11px;color:var(--blue);font-weight:850;margin-top:7px}.utilitytab{display:flex;justify-content:space-between;align-items:center;margin:22px 0 10px;padding:15px 16px;border:1px solid #dfe6f2;border-radius:18px;background:linear-gradient(135deg,#f8fbff,#eef4ff);cursor:pointer;box-shadow:0 7px 20px #0b57e30d;transition:transform .15s ease,box-shadow .15s ease,border-color .15s ease}.utilitytab span{display:flex;align-items:center;gap:9px}.utilitytab small{display:block;color:var(--muted);font-size:10px;margin-top:2px}.projects.collapsed{display:none}.utilitytab:hover,.homecar:hover,.sectionlink:hover{border-color:#b9c9ea}.homebtn,.back,.btn,.hero button,.chip,.sectionlink,.p,.utilitytab,.homecar{cursor:pointer}@media (max-width:767px){.homevehicles{display:flex;overflow-x:auto;scroll-snap-type:x mandatory;padding:2px 2px 10px;margin-right:-16px;padding-right:16px;scrollbar-width:none}.homevehicles::-webkit-scrollbar{display:none}.homecar{flex:0 0 78%;scroll-snap-align:start}.projects{grid-template-columns:1fr 1fr}} @media (min-width:768px){.homecar:hover,.p:hover,.utilitytab:hover{transform:translateY(-2px);box-shadow:0 9px 24px #0b57e31a;border-color:#b9c9ea}.homecar:active,.p:active,.utilitytab:active{transform:translateY(0)}.hero button:hover,.btn:hover,.homebtn:hover{filter:brightness(1.06);transform:translateY(-1px)}.chip:hover,.sectionlink:hover,.back:hover{background:#eef4ff}.homevehicles{grid-template-columns:repeat(3,minmax(0,1fr))}.homecar{min-height:145px}.utilitytab{margin-top:28px}}@media (max-width:767px){.app{width:100%;max-width:520px}.projects{grid-template-columns:1fr 1fr}.list{grid-template-columns:1fr}.row{min-width:0}.chips{overflow-x:auto;-webkit-overflow-scrolling:touch}.chip{flex:0 0 auto}.homebtn{display:block}}
@media (min-width:768px){.p{cursor:pointer;transition:transform .15s ease,box-shadow .15s ease,border-color .15s ease}.p:hover{transform:translateY(-2px);border-color:#b9c9ea;box-shadow:0 8px 22px #0b57e31a}.p:active{transform:translateY(0);box-shadow:0 3px 10px #0b57e312}}.ico{width:38px;height:38px;border-radius:11px;background:#eef4ff;display:grid;place-items:center;font-size:20px}.p b{font-size:13px}.p small{display:block;color:var(--muted);font-size:10px;margin-top:3px}.homebtn{position:fixed;left:50%;bottom:18px;transform:translateX(-50%);border:1px solid var(--line);background:#fff;color:var(--blue);border-radius:999px;padding:10px 18px;font-weight:800;box-shadow:0 7px 25px #0001;z-index:9}.page{display:none}.page.on{display:block}.back{border:0;background:none;font-size:25px;padding:4px 8px 4px 0}.pagehead{display:flex;align-items:center;gap:8px;margin-bottom:16px}.pagehead h2{margin:0;font-size:21px}.panel{border:1px solid var(--line);border-radius:18px;padding:15px;margin-bottom:12px}.field{display:block;margin:12px 0 6px;font-size:12px;font-weight:800}.input,select,textarea{width:100%;border:1px solid #d9dee8;border-radius:13px;padding:13px;font-size:16px;background:#fff}textarea{height:88px}.btn{width:100%;border:0;border-radius:13px;padding:14px;background:var(--blue);color:#fff;font-size:15px;font-weight:800;margin-top:12px}.green{background:#168f50}.purple{background:#6857df}.result{display:none;margin-top:12px;border-radius:16px;background:#f3f7ff;padding:16px}.result .big{font-size:28px;font-weight:900;color:var(--blue);text-align:center;margin:8px 0}.list{display:grid;gap:10px}.row{border:1px solid var(--line);border-radius:16px;padding:13px}.rowtop{display:flex;justify-content:space-between;gap:8px}.row .tag{background:#e8f8ee;color:#168143;padding:4px 8px;border-radius:999px;font-size:10px;height:max-content}.row .name{font-weight:850}.row .meta{font-size:12px;color:var(--muted);margin-top:4px;line-height:1.4}.price{margin-top:10px;font-size:10px;color:var(--muted)}.price b{display:block;color:#111;font-size:17px;margin-top:2px}.row{min-width:0}.row .name{overflow-wrap:anywhere}.row .meta{overflow-wrap:anywhere}.price b{overflow-wrap:anywhere}.filebox{position:relative;border:2px dashed #d6dbe5;border-radius:14px;padding:18px;text-align:center;margin:10px 0;color:var(--muted);font-size:12px}.filebox input{position:absolute;inset:0;opacity:0;width:100%;height:100%}.note{font-size:11px;color:var(--muted);line-height:1.5;margin-top:8px}

/* Cloud Run auto-deploy pipeline test */
@media (min-width:768px){body{background:#eef2f7}.app{max-width:1180px;padding:28px 32px 40px;box-shadow:0 0 30px #0000000a}.top{margin:0 0 24px}.brandname{font-size:28px}.hero{padding:24px;border-radius:24px}.hero h2{font-size:28px}.herofoot{gap:70px}.herofoot b{font-size:28px}.projects{grid-template-columns:repeat(3,1fr);gap:16px}.p{padding:18px;min-height:78px}.p b{font-size:15px}.sec{margin-top:24px}.list{grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.row{padding:16px}.homebtn{display:none}.pagehead h2{font-size:25px}.panel{padding:20px}}
.vehicle-main{display:flex;align-items:center;gap:11px;min-width:0}.vehicle-mini{width:78px;height:54px;flex:0 0 78px;border-radius:12px;overflow:hidden;background:linear-gradient(135deg,#edf3ff,#f7f9fc);display:grid;place-items:center;font-size:25px}.vehicle-mini img{width:100%;height:100%;object-fit:contain;object-position:center;display:block;padding:3px}.homecar .carpic{height:150px;border-radius:14px;background:linear-gradient(135deg,#eaf1ff,#f7f9fc);display:grid;place-items:center;overflow:hidden;margin-bottom:10px;font-size:30px}.homecar .carpic img{width:100%;height:100%;object-fit:contain;object-position:center;display:block;padding:0}.homecar .carbrand{font-size:12px;color:var(--muted);font-weight:650}.homecar .carmodel{font-size:15px;font-weight:750;line-height:1.3;margin-top:3px;overflow-wrap:anywhere}.homecar .carprice{font-size:12px;color:var(--blue);font-weight:750;margin-top:7px}.row .name{font-size:15px;font-weight:750}.row .meta{font-size:13px}.p b{font-size:16px;font-weight:700}.p small{font-size:11px}.sec h3{font-size:20px;font-weight:700}.hero h2{font-weight:750}.sub{font-size:13px}.herofoot small{font-size:11px}.hero button,.btn{font-weight:700}<style>@media (max-width:767px){.homevehicles{display:flex;overflow-x:auto;gap:12px;scroll-snap-type:x mandatory;padding-bottom:5px}.homecar{flex:0 0 78%;scroll-snap-align:start}.homecar .carpic{height:155px}}@media (min-width:768px){.homecar .carpic{height:170px}}</style></style></head><body><main class="app">
...
function otvRateFor(v){let p=Number(v.price||0),b=(v.brand||'').toUpperCase(),m=(v.model||'').toUpperCase();if(!p)return null;let solve=(rules)=>{for(let [r,min,max] of rules){let base=p/1.20/(1+r);if(base>min&&(max==null||base<=max))return r}return null};if(b==='TOGG')return solve([[.25,0,1650000],[.55,1650000,null]]);if(b==='TOYOTA'&&m.includes('C-HR'))return solve([[.70,0,1250000],[.80,1250000,null]]);if(b==='TOYOTA'&&m.includes('COROLLA'))return solve([[.75,0,850000],[.80,850000,1100000],[.90,1100000,1650000],[1.00,1650000,null]]);if(b==='FIAT'&&m.includes('ULYSSE'))return solve([[1.50,0,1650000],[1.70,1650000,null]]);if(b==='FIAT'&&m.includes('EGEA'))return solve([[.75,0,850000],[.80,850000,1100000],[.90,1100000,1650000],[1.00,1650000,null]])||solve([[.70,0,650000],[.75,650000,900000],[.80,900000,1100000],[.90,1100000,null]]);return solve([[.70,0,650000],[.75,650000,900000],[.80,900000,1100000],[.90,1100000,null]])}function exemptPrice(v){let r=otvRateFor(v);return r==null?null:Math.round(Number(v.price)/(1+r))}function vehicleImage(v){let b=(v.brand||'').toUpperCase(),m=(v.model||'').toUpperCase();if(b==='RENAULT'&&m.includes('BOREAL'))return 'https://www.automovelnacional.com.br/admin/imagens/editor/2002102722.jpg';if(b==='RENAULT'&&m.includes('DUSTER'))return 'https://imgd.aeplcdn.com/1920x1080/n/cw/ec/163801/duster-exterior-right-front-three-quarter-5.jpeg?isig=0&q=90';if(b==='RENAULT'&&m.includes('CLIO'))return 'https://cms.bilhandel.dk/media/gihc2rsz/g0vc5o6wmaaitkp.jpeg';if(b==='RENAULT'&&m.includes('MEGANE'))return 'https://www.renault.com.tr/binek-araclar/megane-sedan.html';if(b==='TOYOTA'&&m.includes('C-HR'))return 'https://toyota-media.ch/__image/a/2248486/alias/xxl/v/4/c/25/ar/16-9/fn/Toyota%20C-HR%202026_01.jpg';if(b==='TOYOTA'&&m.includes('COROLLA'))return 'https://modenamotorsgmbh.com/98819-thickbox_default/toyota-corolla-sedan-18-hybrid-elite-edition-my2026.jpg';if(b==='HYUNDAI'&&m.includes('BAYON'))return 'https://pro.bbcdn.io/9e/9ee7684a-7e64-4d8c-9adb-ae55cf82ca10?format=.jpg&rule=legacy-largest';if(b==='TOGG')return 'https://www.togg.eu/assets/img/68a4514343d1be59b0dab71b_T10X-Range.webp';if(b==='FIAT'&&m.includes('EGEA'))return 'https://arbstorage.mncdn.com/modelphotos/60cf26a2-ff58-461c-a8a5-fbc3cbce58b1_912x513.jpg';if(b==='FIAT'&&m.includes('ULYSSE'))return 'https://manage.sifiraracal.com/public/resim/galeri/1002/43084/fiat-ulysse.png';return ''}function verifiedRow(v){let ep=exemptPrice(v),img=vehicleImage(v);return `<div class="row"><div class="rowtop"><div class="vehicle-main"><div class="vehicle-mini">${img?`<img src="${img}" loading="lazy" alt="${v.brand} ${v.model}" onerror="this.parentElement.textContent='🚗';">`:'🚗'}</div><div><div class="name">${v.brand} ${v.model}</div><div class="meta">${v.trim||''}</div></div></div><span class="tag">Uygun</span></div><div class="price">Liste Fiyatı<b>${tl(v.price)}</b></div>${ep?`<div class="price">Tahmini ÖTV Muaf Fiyat<b>${tl(ep)}</b></div>`:''}<div class="note">Yerlilik: %${v.locality||'—'} · Kaynak: ${v.source_name||v.brand} · Son kontrol: ${v.checked_at||'—'}</div></div>`}
